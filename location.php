                            ...
                            <div class="relative p-4 rounded-[10px] shadow-[4px_7px_15px_rgba(75,75,77,.25)]">
                                ...
                                <div class="flex items-center max-[1024px]:flex-col gap-4">
                                    ...
                                    <div class="w-[50%] max-[1024px]:w-full">
                                        ...
                                        <div class="mt-4">
                                            <div
                                                class="text-white openModalBtn bg-[#ff000d] px-[5rem] py-1 cursor-pointer shadow-[10px_7px_20px_rgb(255,9,9,38%)] text-center max-[1024px]:mx-auto w-fit rounded-[5px]">
