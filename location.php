        ...
        <div class="w-[80%] max-[1024px]:w-[90%] mx-auto">
            <div class="grid grid-cols-4 max-[1024px]:grid-cols-1 gap-10">
                <div class="h-fit col-span-1">
                    ...
                    <div class="text-black text-center bg-[#f1f4f8] p-4 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-2 font-semibold text-[12px]">
                            <a href='<?php echo $locationData["location"]["slug"]; ?>?sort=Economy&id=1' class="bg-white border border-[#b8101f] py-2 px-4">Economy</a>
                            <a href='<?php echo $locationData["location"]["slug"]; ?>?sort=SUV&id=2' class="bg-white border border-[#b8101f] py-2 px-4">SUV</a>
                            <a href='<?php echo $locationData["location"]["slug"]; ?>?sort=Midsize&id=3' class="bg-white border border-[#b8101f] py-2 px-4">Midsize</a>
                            <a href='<?php echo $locationData["location"]["slug"]; ?>?sort=Featured&id=4' class="bg-white border border-[#b8101f] py-2 px-4">Featured</a>
                            <a href='<?php echo $locationData["location"]["slug"]; ?>?sort=Crossover&id=5' class="bg-white border border-[#b8101f] py-2 px-4">Crossover</a>
                        </div>
                    </div>
                    <div class="text-black text-center bg-[#f1f4f8] p-4 mb-6">
                ...
                <!-- <div class="text-black mt-6 string">
                    <?php echo $locationData["cars"]["data"]["description_en"]; ?>
                </div> -->
            </div>
        </div>
        </div>
