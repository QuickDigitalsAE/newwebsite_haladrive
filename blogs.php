...
if ($slug) {
    ...
    <section class="relative">
        <div class="w-[90%] max-[1024px]:w-[90%] mx-auto py-16 max-[1024px]:py-10">
            <div class="">
                <div class="">
                    <img src="<?php echo $singleBlogContentData["blog"]["image_url"]; ?>" class="rounded-[10px]" alt="<?php echo $singleBlogContentData["blog"]["img_alt_en"]; ?>">
                    <div class="">
                        <div class="font-bold text-[#939393] text-[1rem] mt-12">10 Nov 2025</div>
                    </div>
                    <div class="mt-6 string">
                        <?php echo $singleBlogContentData["blog"]["description_en"]; ?>
                    </div>
                </div>
            </div>
        </div>
