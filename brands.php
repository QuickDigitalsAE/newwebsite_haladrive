                ...
                <div class="h-fit col-span-1">
                    ...
                    <div class="text-black text-center bg-[#f1f4f8] p-4 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-2 font-semibold text-[12px]">
                            <a href='brands/<?php echo $brandData["brand"]["slug"]; ?>?sort=Economy&id=1' class="bg-white border border-[#b8101f] py-2 px-4">Economy</a>
                            <a href='brands/<?php echo $brandData["brand"]["slug"]; ?>?sort=SUV&id=2' class="bg-white border border-[#b8101f] py-2 px-4">SUV</a>
                            <a href='brands/<?php echo $brandData["brand"]["slug"]; ?>?sort=Midsize&id=3' class="bg-white border border-[#b8101f] py-2 px-4">Midsize</a>
                            <a href='brands/<?php echo $brandData["brand"]["slug"]; ?>?sort=Featured&id=4' class="bg-white border border-[#b8101f] py-2 px-4">Featured</a>
                            <a href='brands/<?php echo $brandData["brand"]["slug"]; ?>?sort=Crossover&id=5' class="bg-white border border-[#b8101f] py-2 px-4">Crossover</a>
                        </div>
                    </div>
                    <div class="text-black text-center bg-[#f1f4f8] p-4 mb-6">
